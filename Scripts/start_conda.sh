...
python Exp/run_model.py --model GIN --dataset IMDB-BINARY --transform_k_wl 3 --k_wl_turbo 0 --batch_size 4 --emb_dim 16 --epochs 100 --k_wl_separate_embedding 0 --k_wl_pool_function cat --device 0 --k_wl_set_based 1
